...
Given a subject's public identifiers (name, email, phone, town/county, approximate age, a
known associate — you supply them), generates a ready-to-click list of investigator-relevant
lookups grouped by identifier type — reputation checks (email/phone), relationship checks
(mutual-connection search), and public-record checks (obituary, police record) — plus a
Markdown checklist for tracking what's been reviewed. Works for any case typology, not just
account takeover.
...
alone is rarely enough to confirm identity — supplying a town, approximate age, or known
...
- [OSINT Tool](https://biancabcarlson.github.io/OSINT-Tool/) *(this repo)*
