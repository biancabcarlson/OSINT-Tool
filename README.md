...
Given a subject's public identifiers (name, email, phone — you supply them), generates a
ready-to-click list of standard public search-engine queries, grouped by identifier type, plus
a Markdown checklist for tracking what's been reviewed.
...
and is pre-filled with the new payee from the `simulated-account` fixture (Marcus T.) as a
working demo.
